...
class BackgroundServicePlugin(private val activity: Activity) : Plugin(activity) {
    ...
    private var restartOnProcessDeath: Boolean = true
    ...
    private fun loadConfig() {
        ...
        restartOnProcessDeath = json.optBoolean("androidRestartOnProcessDeath", true)
    ...
    fun startKeepalive(invoke: Invoke) {
        ...
        prefs().edit()
            ...
            .putBoolean("bg_restart_on_process_death", restartOnProcessDeath)
    ...
    fun stopKeepalive(invoke: Invoke) {
        ...
        activity.startService(Intent(activity, LifecycleService::class.java)
            .apply { action = LifecycleService.ACTION_APP_STOP })
        invoke.resolve()
    }
