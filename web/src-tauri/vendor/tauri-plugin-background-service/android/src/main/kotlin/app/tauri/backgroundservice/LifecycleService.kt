...
class LifecycleService : Service() {
    ...
    companion object {
        ...
        const val ACTION_APP_STOP = "APP_STOP"
        const val ACTION_NOTIFICATION_STOP = "NOTIFICATION_STOP"
        ...
        fun buildStartState(
            ...
            restartOnProcessDeath: Boolean = true,
        ): DurableState {
            return previous.copy(
                desiredRunning = restartOnProcessDeath,
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (action == ACTION_APP_STOP || action == ACTION_NOTIFICATION_STOP) {
            ...
            getSharedPreferences("bg_service", Context.MODE_PRIVATE).edit()
                ...
                .remove("bg_restart_on_process_death")
        ...
        val restartOnProcessDeath = restartOnProcessDeath()
        DurableState.save(
            this,
    ...
    private fun restartOnProcessDeath(): Boolean =
        notifPrefs().getBoolean("bg_restart_on_process_death", true)
