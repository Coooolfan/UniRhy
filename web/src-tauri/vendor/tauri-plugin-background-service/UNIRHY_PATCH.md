...
Run the focused Android patch tests from `web/src-tauri/gen/android`:

```shell
./gradlew :tauri-plugin-background-service:testDebugUnitTest --tests app.tauri.backgroundservice.UniRhyLifecyclePatchTest
```
