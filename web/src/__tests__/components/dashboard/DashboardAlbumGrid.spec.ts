    ...
    rows: [
        {
            ...
            cover: { id: 401, url: '/api/media-files/401?_sig=a&_exp=9999999999' },
        },
    ],
    totalPageCount: 1,
    totalRowCount: 1,
...
describe('DashboardAlbumGrid', () => {
    ...
    it('prefers default playable recording when loading album playback details', async () => {
            ...
            recordings: [
                ...
                },
                {
                    ...
                    assets: [
                        {
                            ...
                            mediaFile: {
                                ...
                                url: '/api/media-files/602?_sig=b&_exp=9999999999',
                            },
                        },
                    ],
                    ...
                    cover: {
                        ...
                        mimeType: 'image/jpeg',
                        size: 456,
                        url: '/api/media-files/702?_sig=c&_exp=9999999999',
                    },
                },
                {
                    id: 503,
                    ...
                    assets: [
                        {
                            ...
                            mediaFile: {
                                ...
                                url: '/api/media-files/603?_sig=d&_exp=9999999999',
                            },
                        },
                    ],
        ...
        expect(audioStore.currentTrack).toEqual(
            expect.objectContaining({
                ...
                title: 'Playable Default',
                artist: 'Artist B',
                cover: '/api/media-files/702?_sig=c&_exp=9999999999',
                src: '/api/media-files/602?_sig=b&_exp=9999999999',
                mediaFileId: 602,
            }),
        )
    })
    ...
    it('prefers the user selected asset format when album playback has multiple audio assets', async () => {
            ...
            recordings: [
                {
                    ...
                    assets: [
                        ...
                        },
                        {
                            ...
                            mediaFile: {
                                ...
                                url: '/api/media-files/603?_sig=c&_exp=9999999999',
                            },
                        },
                    ],
                    artists: [{ id: 802, displayName: 'Artist B', alias: [], comment: '' }],
                    cover: {
                        ...
                        mimeType: 'image/jpeg',
                        size: 456,
                        url: '/api/media-files/702?_sig=d&_exp=9999999999',
                    },
                },
            ],
        })
        ...
        expect(audioStore.currentTrack).toEqual(
            expect.objectContaining({
                id: 502,
                src: '/api/media-files/603?_sig=c&_exp=9999999999',
                mediaFileId: 603,
            }),
        )
    })
