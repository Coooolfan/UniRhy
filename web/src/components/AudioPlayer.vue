        ...
        <div class="max-w-7xl mx-auto flex items-center justify-between gap-4">
            ...
            <div class="flex flex-col items-center flex-1 max-w-2xl gap-1">
                <div class="flex items-center gap-6">
                    <button class="text-[#8C857B] hover:text-[#C17D46] transition-colors" disabled>
                        <SkipBack :size="20" />
                    </button>
                ...
                >
                    ...
                    <div class="relative flex-1 h-1 bg-[#EFEBE4] rounded-full group cursor-pointer">
                        <input
                            type="range"
                            min="0"
            ...
            <div class="flex items-center justify-end gap-4 w-1/4">
                <div class="flex items-center gap-2 group">
                    ...
                    <div class="w-20 h-1 bg-[#EFEBE4] rounded-full relative overflow-hidden">
                        <input
                            type="range"
                            min="0"
                            max="1"
                ...
                <button
                    ...
                    class="ml-4 p-1 text-[#DCD6CC] hover:text-[#8C857B] transition-colors"
                >
                    <X :size="20" />
                </button>
            </div>
