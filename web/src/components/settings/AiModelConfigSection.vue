...
import {
    AiRequestFormat_CONSTANTS,
    type AiRequestFormat,
} from '@/__generated/model/enums/AiRequestFormat'
...
<template>
    <section class="mb-16 animate-in fade-in duration-500 font-serif">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
                <div
                    class="flex items-center justify-between px-5 py-4 border-b border-[#E8E4D9] bg-[#F4F1EA]"
                >
                ...
                <div v-if="isEditing !== card.type" class="px-5 py-4 space-y-3">
                    <template v-if="card.config">
                        <div>
                            <div
                                class="text-[10px] tracking-[0.15em] text-[#A39E93] uppercase mb-1"
                            >
                                Endpoint
                            </div>
                            <div class="font-mono text-xs text-[#66635C] truncate">
                        ...
                        <div>
                            ...
                            <div class="font-mono text-xs text-[#66635C]">
                                {{ card.config.model }}
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <span
                                class="inline-block bg-[#EBE6D9] text-[#66635C] text-[10px] px-2 py-0.5 rounded-sm"
                            >
                ...
                <div v-else class="px-5 py-4 space-y-3">
                    <div>
                        <label
                            class="text-[10px] tracking-[0.15em] text-[#A39E93] uppercase mb-1 block"
                            >Endpoint</label
                        >
                        <input
                            :value="form.endpoint"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select
                                ...
                                @change="
                                    emit('update-form', {
                                        requestFormat: ($event.target as HTMLSelectElement)
                            ...
                            >
                                <option
                                    v-for="fmt in AiRequestFormat_CONSTANTS"
                                    :key="fmt"
                                    :value="fmt"
                                >
                            ...
                            <ChevronDown
                                :size="12"
                                class="absolute right-2.5 top-1/2 -translate-y-1/2 text-[#A39E93] pointer-events-none"
                            />
                        </div>
                    </div>
